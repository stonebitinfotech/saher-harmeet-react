    ...
    <main id="invitation">
      ...
      <EventSection id="mehndi">
        ...
        <p className="event-body">
          We are kicking off the wedding madness please join us for an evening
          of mehndi, music and lots of dancing to celebrate.
        </p>
      ...
      {/* Haldi by the River + Engagement & Sangeet night (wrapped together as in the original) */}
      <div className="haldi-block">
        <EventSection id="haldi">
          ...
          <p className="event-body">
            Come adorn the couple from head to toe with yellow sunshine and watch
            them glow.
          </p>
          ...
          <EventVenue href="https://maps.app.goo.gl/cL8A42gVckADpZm96?g_st=ic">
            River Side, 72 Villa, Silent Zone, Near New Weekend Address, Opp.
            Airport, Surat
          </EventVenue>
        </EventSection>
        ...
        <EventSection id="starry">
          ...
          <p className="event-body">
            Get ready for an enchanted evening as we dance our way towards our
            beginning of forever.
          </p>
          <p className="event-when">10th December 2026</p>
          <p className="event-when">7:30 PM onwards</p>
          <EventVenue href="https://maps.app.goo.gl/cL8A42gVckADpZm96?g_st=ic">
            72 Villa, Silent Zone, Near New Weekend Address, Opp. Surat Airport
          </EventVenue>
        </EventSection>
      ...
      <EventSection id="anandkaraj">
        ...
        <EventVenue href="https://maps.app.goo.gl/u5bmiQ36fidv5i6MA">
          Gurudwara Guru Tegh Bahadur Sahib, Guru Nanak Devi Marg, Bhatar Road,
          Surat
        </EventVenue>
